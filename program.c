...
//entrada == in
    if(strcmp(in->nome_comando, "save") == 0){

        save(img, in->comando_string);
    }

    else if(strcmp(in->nome_comando, "image") == 0){

        image(img, in->parametros);   
    }

    else if(strcmp(in->nome_comando, "color") == 0){

        color(img, in->parametros);
    }

    else if(strcmp(in->nome_comando, "clear") == 0){

        clear(img, in->parametros);
    }

    else if(strcmp(in->nome_comando, "line") == 0){

        line(img, in->parametros);
    }

    else if(strcmp(in->nome_comando, "open") == 0){

        open(img, in->comando_string);
    }

    else if(strcmp(in->nome_comando, "polygon") == 0){

        polygon(img, *entrada);
    }

    else if(strcmp(in->nome_comando, "rect") == 0){

        rect(img, entrada->parametros);
    }

    else if(strcmp(in->nome_comando, "circle") == 0){

        circle(img, in->parametros);
    }

    else if(strcmp(in->nome_comando, "fill") == 0){

        fill(img, in->parametros);
    }

    else if(strcmp(in->nome_comando, "repeat-line") == 0){

        repeat_line(img, entrada->parametros, ultima_entrada);
    }

    else if(strcmp(in->nome_comando, "copy-polygon") == 0){

        copy_polygon(img, entrada->parametros, ultima_entrada);
    }

    else if(strcmp(in->nome_comando, "repeat-polygon") == 0){
